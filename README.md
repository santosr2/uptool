...
- `@v0.2` - Automatically updated to latest `v0.1.x` patch
- `@v0.2.0-alpha20251122` - Fixed to exact release (never changes)

**Pre-release tags** (for testing):

- `@v0-rc` - Latest release candidate in v0
- `@v0.2-rc` - Latest release candidate in v0.1
- `@v0.2.0-alpha20251122-rc.1` - Exact pre-release (immutable)
